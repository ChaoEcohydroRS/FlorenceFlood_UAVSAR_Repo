...
#    inc_filenameNoExt=os.path.splitext(os.path.basename(inc_file_name))[0]
    ...
    #var image = ee.Image("projects/GlobalReservoirs/UAVSAR/
    #UA_cpfear_13510_18065_Cols/UA_cpfear_13510_18065_008_180918_L090_CX_01_D_Freeman_Dbl");
...
#                   GeoTiffOutputFolder+"/"+"UA_"+hgt_filenameNoExt+"_hgt")
    ...
    print(PegLongitude, PegLatitude)
    ...
    print('AscendingOrNot',AscendingOrNot)
...
#    os.path.splitext(os.path.basename(IncFiles))[0]+"_inc.tif"
    ...
    AngleMask=IncidenceAngle.neq(0)
#    AngleMask=IncidenceAngle.lt(-100).Not()
    ...
    azimuthEdgeGeometry=ee.Algorithms.If(AscendingOrNot,
            ...
            ee.Geometry.LineString([crdLons.get(crdLats.indexOf(minLat)
    ...
    theta_iRad = distance.divide(ee.Image.constant(FlightHeight).subtract(
            ee.Image.constant(AverageTerrain))).atan().toFloat()
